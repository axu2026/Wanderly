...
// Itinerary feature uses Places API (New) — separate from the legacy
// PlacesApi used by the home recommendations.
...
object ItineraryPlacesRetrofit {
    private const val BASE_URL = "https://places.googleapis.com/"

    val api: ItineraryPlacesApi by lazy {
        Retrofit.Builder()
            .baseUrl(BASE_URL)
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(ItineraryPlacesApi::class.java)
    }
